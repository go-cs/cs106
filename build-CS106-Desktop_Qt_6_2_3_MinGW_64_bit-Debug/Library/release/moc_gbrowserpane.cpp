...
#include <memory>
#include "../../../CS106/Library/graphics/gbrowserpane.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata__Internal_QTextBrowser_t, stringdata0) + ofs), len 
...
const QMetaObject _Internal_QTextBrowser::staticMetaObject = { {
    ...
    qt_meta_stringdata__Internal_QTextBrowser.offsetsAndSize,
