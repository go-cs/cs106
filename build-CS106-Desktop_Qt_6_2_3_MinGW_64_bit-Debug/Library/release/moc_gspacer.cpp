...
#include <memory>
#include "../../../CS106/Library/graphics/gspacer.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata__Internal_QSpacer_t, stringdata0) + ofs), len 
static const qt_meta_stringdata__Internal_QSpacer_t qt_meta_stringdata__Internal_QSpacer = {
    {
QT_MOC_LITERAL(0, 17) // "_Internal_QSpacer"
...
const QMetaObject _Internal_QSpacer::staticMetaObject = { {
    ...
    qt_meta_stringdata__Internal_QSpacer.offsetsAndSize,
    qt_meta_data__Internal_QSpacer,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata__Internal_QSpacer_t
