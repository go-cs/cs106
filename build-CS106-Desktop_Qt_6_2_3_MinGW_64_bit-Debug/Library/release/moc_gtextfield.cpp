...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata__Internal_QLineEdit_t, stringdata0) + ofs), len 
...
const QMetaObject _Internal_QLineEdit::staticMetaObject = { {
    ...
    qt_meta_stringdata__Internal_QLineEdit.offsetsAndSize,
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata__Internal_QSpinBox_t, stringdata0) + ofs), len 
...
const QMetaObject _Internal_QSpinBox::staticMetaObject = { {
    ...
    qt_meta_stringdata__Internal_QSpinBox.offsetsAndSize,
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata__Internal_QDoubleSpinBox_t, stringdata0) + ofs), len 
...
const QMetaObject _Internal_QDoubleSpinBox::staticMetaObject = { {
    ...
    qt_meta_stringdata__Internal_QDoubleSpinBox.offsetsAndSize,
