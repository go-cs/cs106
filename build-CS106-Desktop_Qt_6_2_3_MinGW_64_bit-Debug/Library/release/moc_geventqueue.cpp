...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_GEventQueue_t, stringdata0) + ofs), len 
...
const QMetaObject GEventQueue::staticMetaObject = { {
    ...
    qt_meta_stringdata_GEventQueue.offsetsAndSize,
    qt_meta_data_GEventQueue,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_GEventQueue_t
, QtPrivate::TypeAndForceComplete<GEventQueue, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
