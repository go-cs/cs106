...
#include <memory>
#include "../../../CS106/Library/graphics/gscrollpane.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata__Internal_QScrollArea_t, stringdata0) + ofs), len 
...
const QMetaObject _Internal_QScrollArea::staticMetaObject = { {
    ...
    qt_meta_stringdata__Internal_QScrollArea.offsetsAndSize,
