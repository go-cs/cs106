...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_GDownloader_t, stringdata0) + ofs), len 
...
QT_MOC_LITERAL(206, 15) // "waitForDownload"
    ...
    "reportNoSSL\0saveDownloadedData\0"
    "std::string\0member\0filename\0sslErrorsNam\0"
    "QNetworkReply*\0QList<QSslError>\0"
    "sslErrorsReply\0waitForDownload"
};
...
void GDownloader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->saveDownloadedData((*reinterpret_cast< const std::string(*)>(_a[1])),(*reinterpret_cast< const std::string(*)>(_a[2]))); break;
        case 5: _t->saveDownloadedData((*reinterpret_cast< const std::string(*)>(_a[1]))); break;
        case 6: _t->sslErrorsNam((*reinterpret_cast< QNetworkReply*(*)>(_a[1])),(*reinterpret_cast< QList<QSslError>(*)>(_a[2]))); break;
        case 7: _t->sslErrorsReply((*reinterpret_cast< QList<QSslError>(*)>(_a[1]))); break;
...
const QMetaObject GDownloader::staticMetaObject = { {
    ...
    qt_meta_stringdata_GDownloader.offsetsAndSize,
