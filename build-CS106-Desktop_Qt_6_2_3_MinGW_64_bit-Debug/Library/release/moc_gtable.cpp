...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata__Internal_QItemDelegate_t, stringdata0) + ofs), len 
...
const QMetaObject _Internal_QItemDelegate::staticMetaObject = { {
    ...
    qt_meta_stringdata__Internal_QItemDelegate.offsetsAndSize,
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata__Internal_QTableWidget_t, stringdata0) + ofs), len 
...
const QMetaObject _Internal_QTableWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata__Internal_QTableWidget.offsetsAndSize,
